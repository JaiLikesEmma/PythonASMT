import easygui  # Import EasyGUI for pop-up dialogs
import pandas as pd  # Import pandas for data handling
import matplotlib.pyplot as plt  # Import matplotlib for graphs
import csv  # Import CSV for data storage
...
# Expense categories
categories = ["Rent", "Utilities", "Groceries", "EatingOut", "Entertainment", "Petrol", "Miscellaneous"]
